...
class CategoryService
{
    ...
    public function store(array $validatedData, boolean $hasIcon, $icon)
    {
    ...
    public function update(Category $category, array $validatedData, boolean $hasIcon, $icon)
    {
    ...
    private function uploadIcon(File $icon, $category)
    {
